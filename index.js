...
const MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/whatsapp-api-db"
...
app.delete("/api/apis/:id", async (req, res) => {
  try {
    ...
    const result = await db.collection("apis").deleteOne({ _id: new ObjectId(req.params.id) })
